...
<div
  id="default-modal"
  aria-hidden="true"
  className={`scrollbar-thin scrollbar-thumb-white scrollbar-track-white fixed top-1/2 left-1/2 rounded-xl transform -translate-x-1/2 -translate-y-1/2 ${toggle ? 'block' : 'hidden'} overflow-y-scroll overflow-x-hidden z-50 w-full max-modal-width-50 max-h-[80%]`}
>
      <div className="relative w-full modal-width-50 max-h-full">
          <div className="p-8 relative bg-white rounded-2xl shadow dark:bg-gray-700">
              <div className="flex border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" onClick={() => setToggle(false)} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal">
